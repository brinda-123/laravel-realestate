            ...
            <div class="card rounded">
              <div class="card-body">
                <div class="d-flex align-items-center justify-content-between mb-2">
                  ...
                  <div>
                  <img class="img-fluid rounded-circle border border-secondary p-1" style="width: 80px; height: 100px; object-fit: cover;" src="{{ (!empty($profileData->photo)) ? url('upload/admin_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="profile">
...
<div class="mb-3">
 ...
 <label for="exampleInputEmail1" class="form-label">    </label>
	<img id="showImage" class="img-fluid rounded-circle border border-secondary p-1" style="width: 80px; height: 100px; object-fit: cover;" src="{{ (!empty($profileData->photo)) ? url('upload/admin_images/'.$profileData->photo) : url('upload/no_image.jpg') }}" alt="profile">
				</div>
